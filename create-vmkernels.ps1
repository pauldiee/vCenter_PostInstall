...
if ((Test-Path .\vsan_vmkernels.csv)){
    ...
    Write-Host Required CSV for vSAN does not exists -ForegroundColor Red
}

#Create vMotion VMkernel
if ((Test-Path .\vmotion_vmkernels.csv)){
    ...
    Write-Host Required CSV for vMotion does not exists -ForegroundColor Red
}

#Create Provisioning VMkernel
if ((Test-Path .\provisioning_vmkernels.csv)){
    ...
    Write-Host Required CSV for Provisioning does not exists -ForegroundColor Red
}
